...
same rule budget as AGENT.md and POLICY.md (the model does not know the text came from
...
one — and restate it in the same words AGENT.md uses. Same words, not a paraphrase: two
